      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-8">
          ...
          >
            ...
            <input
              ...
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-full pl-10 pr-4 py-2 w-80 text-sm focus:outline-none focus:ring-2 focus:ring-[#C1B6FD] text-white placeholder:text-gray-500"
            />
          </motion.div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 bg-[#745CB4] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">7</span>
          </motion.button>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-[#745CB4]/30 rounded-full hover:bg-white/10 transition-all duration-200"
            >
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-sm font-medium">Active: <span className="text-[#C1B6FD]">{activeRole}</span></span>
              </div>
