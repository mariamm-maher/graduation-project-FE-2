  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Agency Performance Dashboard</h1>
          <p className="text-gray-400">Unified overview of all campaigns, influencers, and social channels</p>
        </div>
        <button className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-[#745CB4] to-[#C1B6FD] text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300">
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-white">Agency Performance Overview</h2>
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-white/5 rounded-xl p-5 border border-white/10 hover:border-blue-400/30 transition-all">
            ...
            <p className="text-3xl font-bold text-white mb-1">$627K</p>
            <p className="text-sm text-gray-400">Budget Spent (74%)</p>
          ...
          <div className="bg-white/5 rounded-xl p-5 border border-white/10 hover:border-purple-400/30 transition-all">
            ...
            <p className="text-3xl font-bold text-white mb-1">18.4M</p>
            <p className="text-sm text-gray-400">Total Reach & Engagement</p>
          </div>
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button className="px-3 py-1 bg-green-500/20 text-green-400 rounded-lg text-xs font-semibold">Active</button>
            <button className="px-3 py-1 bg-white/5 text-gray-400 rounded-lg text-xs font-semibold hover:bg-white/10 transition-all">Completed</button>
            <button className="px-3 py-1 bg-white/5 text-gray-400 rounded-lg text-xs font-semibold hover:bg-white/10 transition-all">Scheduled</button>
          </div>
        </div>
            ...
            <div key={idx} className="bg-white/5 rounded-xl p-4 border border-white/10 hover:border-purple-400/30 transition-all group">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  <h3 className="text-white font-semibold group-hover:text-[#C1B6FD] transition-colors">{campaign.name}</h3>
              ...
              <div className="grid grid-cols-5 gap-4">
                <div>
                  ...
                  <p className="text-lg font-bold text-white">{campaign.engagement}</p>
                </div>
                <div>
      ...
      {/* Two Column Layout for Channel Insights and Financial Tracking */}
      <div className="grid grid-cols-2 gap-6">
        {/* Channel Management Insights */}
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-white mb-6">Channel Performance Insights</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10 hover:border-purple-400/20 transition-all">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-white mb-6">Financial & Budget Tracking</h2>
              ...
              {[
                ...
                <div key={idx} className="bg-white/5 rounded-lg p-3 border border-white/10">
                  ...
                  <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                    <div 
                      className={`h-full bg-linear-to-r from-${item.color}-500 to-${item.color}-400`}
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-white">Key Performance Insights</h2>
