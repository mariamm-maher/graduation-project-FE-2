    ...
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-5">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-[#C1B6FD]">$86,100</p>
        </div>
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-5">
          <p className="text-sm text-gray-400 mb-1">Avg Performance</p>
          <div className="flex items-center gap-2">
            <p className="text-2xl sm:text-3xl font-bold text-white">4.7</p>
          ...
          >
            ...
            <div className="flex items-start gap-4 mb-5">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-lg sm:text-xl font-bold text-white truncate">{influencer.name}</h3>
                <p className="text-sm text-gray-400">{influencer.niche}</p>
              </div>
              <div className="text-right hidden sm:block">
                <p className="text-xs text-gray-400">Last Campaign</p>
                <p className="text-sm font-semibold text-white">{influencer.lastCampaign}</p>
              </div>
            </div>

            {/* Last Campaign on Mobile */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-center sm:text-left">
                ...
                <p className="text-base sm:text-lg font-bold text-[#C1B6FD]">{influencer.totalRevenue}</p>
              </div>
              <div className="bg-white/5 rounded-lg p-3 text-center sm:text-left">
                <p className="text-xs text-gray-400 mb-1">Performance</p>
                <p className="text-base sm:text-lg font-bold text-green-400">{influencer.performance}</p>
              </div>
              <div className="bg-white/5 rounded-lg p-3 text-center sm:text-left">
                <p className="text-xs text-gray-400 mb-1">Completed</p>
                <p className="text-xs sm:text-sm font-semibold text-white">{influencer.completionDate}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button className="flex-1 px-4 py-2.5 bg-linear-to-r from-[#745CB4] to-[#C1B6FD] text-white rounded-lg text-sm font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all">
