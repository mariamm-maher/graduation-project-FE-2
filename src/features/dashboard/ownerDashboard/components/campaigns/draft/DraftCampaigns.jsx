import { Search, Calendar, FileEdit, Trash2, Edit, Target, DollarSign, Clock } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm sm:text-base mt-1">
            Unfinished campaigns — not yet operational ({draftCampaigns.length})
          </p>
        </div>
        <button 
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        if (window.confirm(`Delete "${draft.campaignName || draft.name || 'Untitled Campaign'}"?`)) {
                          // Handle delete
