...
//   const { id } = useParams();
//   const { getContractByCollaboration, signContractAsInfluencer, signContractAsOwner } = useCollaborationContractsStore();
...
//     setIsSigning(true);
//     const response = await signContractAsOwner(contractId);
//     if (response?.success) {
//       toast.success('Contract signed as owner');
//       const fresh = await getContractByCollaboration(id);
//       if (fresh?.success && fresh?.data) {
//         const payload = fresh.data;
//         setContract(payload?.contract && typeof payload.contract === 'object' ? payload.contract : payload);
...
//         <Link to="/dashboard/owner/contracts" className="inline-block text-sm text-[#C1B6FD] hover:underline">
//           ← Back to Contracts
//         </Link>
...
//         <Link to="/dashboard/owner/contracts" className="text-sm text-[#C1B6FD] hover:underline self-start">
//           Back to Contracts
//         </Link>
...
//           <Link to={`/dashboard/owner/collaborations/${contract.collaborationId || id}/workspace`}>
