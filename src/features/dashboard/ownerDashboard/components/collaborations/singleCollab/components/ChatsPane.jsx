...
export default function ChatsPane() {
  ...
  const otherParticipant = activeRoom?.participants?.[0];
  const activeRoomLabel = activeRoom?.name || otherParticipant?.name || 'Chat';
        ...
        <div className="flex flex-col bg-[#1A112C]/40 backdrop-blur-sm">
          {!selectedRoomId ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-[#9CA3AF] text-sm">Choose a collaboration chat from the left to get started.</p>
            </div>
          ) : (
            <>
