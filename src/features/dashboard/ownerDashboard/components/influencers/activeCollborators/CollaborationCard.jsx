import { CheckCircle2, Clock, AlertCircle, Instagram, Youtube, ListTodo, MessageSquare, FileText } from 'lucide-react';
import { motion } from 'framer-motion';

function CollaborationCard({ collab, onOpenChat }) {
    ...
    >
      ...
      <div className="p-4 border-t border-white/10 bg-white/5 grid grid-cols-3 gap-2">
        ...
        <button 
          ...
          className="px-3 py-2 bg-linear-to-r from-[#745CB4] to-[#C1B6FD] hover:shadow-lg hover:shadow-purple-500/30 rounded-lg text-xs font-semibold text-white transition-all flex items-center justify-center gap-1.5 relative"
        >
